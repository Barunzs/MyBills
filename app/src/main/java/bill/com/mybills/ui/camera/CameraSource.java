...
public class CameraSource {
    ...
    private Camera createCamera() {
        ...
        Camera camera = null; //= Camera.open(requestedCameraId);
        try {
            ...
            // The most sensible solution would be to quit the entire flow once the picture is sent.
            camera = Camera.open(requestedCameraId);
        } catch(Exception e) {
            Log.e(TAG, "failed to open Camera");
            //Crashlytics.log("failed to open Camera");
            //Crashlytics.logException(e);
            throw new RuntimeException("Could not open requested camera.");
        }
