...
import bill.com.mybills.model.UserProfile
...
internal class EditProfileFragment : Fragment() {
    ...
    private fun onClickScanButton(view: View) {
        ...
        val user = UserProfile("8888888", "SSSSS", "9i9j98huuuhh", "kkkkjkjhkjljjjhhghkkv")
        db?.collection("users")?.document("LA")?.set(user)
